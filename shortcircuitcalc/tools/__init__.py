...
classes for electrical system calculations.

Modules:
    - tools: Module provides tools for the main functionality of the program.
    - elements: Module contains classes and dataclasses for various electrical elements.
